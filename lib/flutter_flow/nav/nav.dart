...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.loggedIn ? SplashPageWidget() : AuthPageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          builder: (context, _) => appStateNotifier.loggedIn ? SplashPageWidget() : AuthPageWidget(),
          routes: [
            FFRoute(
              name: 'BluetoothPage',
              path: 'bluetoothPage',
            ...
            FFRoute(
              ...
              builder: (context, params) => DevicePageWidget(
                ...
                hasWriteCharacteristic: params.getParam('hasWriteCharacteristic', ParamType.bool),
              ),
            ),
            FFRoute(
              name: 'PolygonIdPage',
